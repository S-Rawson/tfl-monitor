...
async def constant_data_pull(dict_of_useful_tube_and_bus_stops, dict_of_useful_bikepoints):
...
#     data_dict = asyncio.run(constant_data_pull(dict_of_useful_tube_and_bus_stops, dict_of_useful_bikepoints))
